...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'If you downloaded Singularity from any app repository like \'F-Droid\', \'IzzyOnDroid\', etc which provide update options, keep this OFF. Whereas, If you downloaded it from \'GitHub\' or any other source which doesn\'t provide auto updates then turn this ON, so as to receive update alerts\n'**
  String get checkUpdateSub;

  /// No description provided for @cleanSongTitle.
  ///
  /// In en, this message translates to:
  /// **'Clean Song Title'**
  String get cleanSongTitle;

  /// No description provided for @cleanSongTitleSub.
  ///
  /// In en, this message translates to:
  /// **'Removes \'(Remastered)\' or \'(Remastered <year>)\' etc from song titles.'**
  String get cleanSongTitleSub;
  ...
  /// No description provided for @numberAlbumSongs.
  ///
  /// In en, this message translates to:
  /// **'Add track number in filename when downloading album'**
  String get numberAlbumSongs;

  /// No description provided for @numberAlbumSongsSub.
  ///
  /// In en, this message translates to:
  /// **'Only works if album is downloaded in a separate folder, ignores download name format'**
  String get numberAlbumSongsSub;
